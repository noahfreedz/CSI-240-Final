...
int main() {
    ...
    int count = 0;
    ThreadNetworks allNetworks(5, .01, .1, startingWeights, startingBiases, input_layer,
    ...
    monitorNetworkSetup(startingWeights, startingBiases, input_layer, number_hidden_layers,
